...
console.log("  -------------------    Nadirah Pinney     -------------------");
console.log("Hello! I see you cant figure out how to transfom a number into a word. Let me help you out");
}
...
function run() {
  ...
  let num = Number(readline.question("enter a number between 0 and 9999: "));
